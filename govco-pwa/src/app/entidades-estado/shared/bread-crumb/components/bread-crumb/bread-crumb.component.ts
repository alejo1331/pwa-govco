...
export class BreadCrumbComponent implements OnInit {
  ...
  constructor(private router: Router, private activatedRoute: ActivatedRoute, private entidadesService: EntidadesService) {
    this.breadCrumb = [];
  }
  ...
  ngOnInit() {
    ...
    this.entidadesService.getTitleAndDescription()
    .subscribe((res) => {
      this.titleEntidad = res.data.titulo;
      this.breadCrumb = [{
        name: this.titleEntidad,
        url: "/"
