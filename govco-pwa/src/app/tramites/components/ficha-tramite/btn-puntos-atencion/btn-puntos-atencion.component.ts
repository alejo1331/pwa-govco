...
@Component({
  selector: 'app-btn-puntos-atencion',
  templateUrl: './btn-puntos-atencion.component.html',
  styleUrls: ['./btn-puntos-atencion.component.scss']
})
export class BtnPuntosAtencionComponent implements OnInit {
