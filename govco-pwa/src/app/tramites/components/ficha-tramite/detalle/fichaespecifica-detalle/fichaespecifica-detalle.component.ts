...
export class FichaespecificaDetalleComponent implements OnInit {
  ...
  getPuntosAtencion() {
    this.fichaTramiteService
      .GetPuntosAtencion(
        this.data.TipoAtencionPresencial,
        1,
        Number(this.data.IdTramite),
        0,
        0
      )
      .subscribe(
  ...
  IconosCostoTramite(data: any) {
    if (data === 'SI') {
      this.urlIconoCostoTramite =
        'https://govco-prod-webutils.s3.amazonaws.com/uploads/2022-06-03/00e9d0ea-698d-43ae-b0dd-2a704207d9ec-Icon_costo.svg';
    } else {
      this.urlIconoCostoTramite =
        'https://govco-prod-webutils.s3.amazonaws.com/uploads/2022-06-03/af2d19cd-5e11-4c96-be10-9af9dff71597-Icon_sin_costo.svg';
    }
  ...
  functionBoton(data: any) {
    if (data === 'En línea') {
      this.urlIconoTipoTramite =
        'https://govco-prod-webutils.s3.amazonaws.com/uploads/2022-06-03/e0029aaa-1feb-4882-8bb6-ee5285be267c-Icon_pc.svg';
    } else if (data === 'Presencial') {
      this.nombreBotonAccion = 'Ver los puntos de atención';
      this.urlIconoTipoTramite =
        'https://govco-prod-webutils.s3.amazonaws.com/uploads/2022-06-03/1eb8a16c-8bc1-4415-8700-7d59dfbc5ca2-Icon_user.svg';
    } else {
      this.nombreTipoTramite = 'Semipresencial';
      this.mostrarIcono = true;
      this.urlIconoTipoTramite =
        'https://govco-prod-webutils.s3.amazonaws.com/uploads/2022-06-24/d71c2341-30c6-42f0-a0f1-cfe0d1409a82-Icon_semipresencial.svg';
    }
