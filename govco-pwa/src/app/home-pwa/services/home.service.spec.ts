...
describe('HomeService', () => {
      ...
      noticias: [
        {
          ...
          cuerpo:
            '<p>Este es el cuerpo de la noticia colombia se une por la misión</p>',
          imagen:
            'https://govco-preprod-webutils.s3.amazonaws.com/uploads/2022-07-26/d0f0eb89-4569-4a85-a8aa-78a0246c8156-articles-237941_foto_marquesina.jpg',
  ...
  const mockInformacionTemasInteres: ObtenerTemasInteresRespuesta = {
    data: {
      ...
      panelInferior: {
        ...
        estado: 1,
        urlLogo:
          'https://www.gov.co/uploads/f09ce111-dda0-4aba-a4ea-b8c2c6279274.webp',
        titulo: 'Portales de Programas Transversales',
        descripcion:
          'Encuentra en un solo lugar acceso a la información de programas de impacto nacional para tu beneficio.',
        seccion: 2,
        tipoPanel: 6,
        idMapaSitio: 7,
        mapaDeSitio: {
      ...
      panelSuperior: {
        ...
        estado: 1,
        urlLogo:
          'https://www.gov.co/uploads/4f0041eb-f559-4575-ba29-d859fe61674f.webp',
      ...
      contenidoPanelInferior: [
        {
          ...
          descripcion:
            'Colombia es hermosa y queremos que conozcas más sobre ella.',
          urlDestino: 'https://www.colombia.co/',
          urlImagen:
            'https://govco-poc.s3.us-east-2.amazonaws.com/uploads/2021-05-14/73a088fc-0f0e-4f63-8a22-7f0ec42e1d36-temasdeinteres_turismo.jpg',
        ...
        },
        {
          ...
          descripcion:
            'Encuentra en un solo lugar ventanillas únicas que te permiten realizar múltiples trámites desde un solo sitio.',
          urlDestino: 'https://beta.www.gov.co/ventanillas-unicas',
          urlImagen:
            'https://govco-poc.s3.us-east-2.amazonaws.com/uploads/2021-05-14/3913de74-4469-4bca-83be-279483bf03ff-Temasdeinteres_Ventanillas.jpg',
        ...
        },
        {
          ...
          urlImagen:
            'https://govco-poc.s3.us-east-2.amazonaws.com/uploads/2021-05-14/e7c46603-9c48-47f0-876b-ae684398738c-Temasdeinteres_Portales.jpg',
        ...
        },
        {
          ...
          descripcion:
            'La información que producen las entidades públicas de su trabajo, todo a tu alcance.',
          urlDestino: 'https://www.datos.gov.co/',
          urlImagen:
            'https://govco-poc.s3.us-east-2.amazonaws.com/uploads/2021-05-14/f594b3a5-de20-4831-8f9f-f0a6fb7f2a44-temasdeinteres_datos.jpg',
        ...
        },
        {
          ...
          descripcion:
            'Las entidades territoriales te atienden sin salir de casa.',
          urlDestino: 'https://beta.www.gov.co/territorial/pqrds/creacion',
          urlImagen:
            'https://govco-poc.s3.us-east-2.amazonaws.com/uploads/2021-05-14/bd8f9cd8-8caa-4584-af5e-a0523c0dc580-Temasdeinteres_territorial.jpg',
        ...
        },
        {
          ...
          urlImagen:
            'https://govco-preprod-webutils.s3.amazonaws.com/uploads/2021-07-17/3a0aa3e3-4082-43d1-baa7-313ed0298654-Temasdeinteres_territorial.jpg',
  ...
  const mockBannerPrincipal: BannerPrincipalModel = {
    data: {
      id: 3,
      textoBienvenida: 'Bienvenido a WWW.GOV.CO',
      urlImagen: null,
      textoDescriptivo: null,
      textoBuscador:
        'Encuentra trámites, servicios e información del Estado colombiano.',
      textoAuxiliar: '¿No sabes cómo buscar?',
      textoBotonAuxiliar: 'Buscar por categorías',
      urlBotonAuxiliar: 'https://www.gov.co/categorias-subcategorias/',
      listaImagenes: [
        {
          id: 1,
          idBanner: 3,
          urlImagen:
            'https://govco-prod-webutils.s3.amazonaws.com/uploads/2021-11-20/d10a99e5-c668-4c80-8f5f-36487e7ff230-1_Calle-colombia-2434911.jpg',
          textoDescriptivo: 'Calle empedrada en Guatapé Colombia',
        },
        {
          id: 2,
          idBanner: 3,
          urlImagen:
            'https://govco-prod-webutils.s3.amazonaws.com/uploads/2021-11-20/1f750fa0-c21d-464b-90d1-bff1f52464cf-2_Paisaje-4924693_1920.jpg',
          textoDescriptivo: 'Cascada natural',
        },
        {
          id: 3,
          idBanner: 3,
          urlImagen:
            'https://govco-prod-webutils.s3.amazonaws.com/uploads/2021-11-20/7130a4cd-5b10-4890-96e1-8784f68a25fd-3_Tayrona bn-2550000_1920.jpg',
          textoDescriptivo: 'Ensenada en parque Tayrona',
        },
        {
          id: 4,
          idBanner: 3,
          urlImagen:
            'https://govco-prod-webutils.s3.amazonaws.com/uploads/2021-11-20/1e35d017-53ba-4d32-83e1-0f094f6d3bd0-4_Tradiciconal-2769786_1920.jpg',
          textoDescriptivo: 'Mujer con traje típico colombiano',
        },
        {
          id: 5,
          idBanner: 3,
          urlImagen:
            'https://govco-prod-webutils.s3.amazonaws.com/uploads/2021-11-20/6780db4d-b162-4ddf-9230-f89faf00e8cf-5_Turismo-2722841_1920.jpg',
          textoDescriptivo: 'Piedra Peñol en Guatapé Colombia',
        },
      ],
    },
    succeeded: true,
  ...
  it('#obtenerNoticias debe retornar la propiedad succeeded como true', (done: DoneFn) => {
    ...
    service
      .obtenerNoticias()
      .subscribe((data: ObtenerBannerNoticiaRespuesta) => {
  ...
  it('#obtenerTemasInteres debe retornar la propiedad succeeded como true', (done: DoneFn) => {
    ...
    service
      .obtenerTemasInteres()
      .subscribe((data: ObtenerTemasInteresRespuesta) => {
        expect(data.succeeded).toBeTrue();
        done();
      });
  });
  ...
  // Banner Principal
  it('#bannerPrincipal debe retornar la propiedad succeeded como true', (done: DoneFn) => {
    httpClientSpy.get.and.returnValue(of(mockBannerPrincipal));

    service.getBannerPrincipal().subscribe((info: BannerPrincipalModel) => {
      expect(info['succeeded']).toBeTrue();
      done();
    });
  });

  it('#bannerPrincipal debe retornar al menos 1 imagen de la lista', (done: DoneFn) => {
    httpClientSpy.get.and.returnValue(of(mockBannerPrincipal));

    service.getBannerPrincipal().subscribe(({ data }: BannerPrincipalModel) => {
      expect(data.listaImagenes.length).toBeGreaterThan(0);
      done();
    });
  });
});
